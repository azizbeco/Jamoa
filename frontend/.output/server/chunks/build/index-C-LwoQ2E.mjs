...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "group relative bg-slate-900/40 border border-blue-900/20 rounded-xl p-6 transition-all hover:bg-blue-900/5 hover:border-blue-600/50 shadow-[0_0_20px_rgba(0,0,0,0.3)] overflow-hidden" }, _attrs))} data-v-5b497d0d><div class="absolute top-0 right-0 w-16 h-16 bg-blue-600/5 rotate-45 transform translate-x-10 -translate-y-10" data-v-5b497d0d></div><div class="relative z-10 flex flex-col h-full" data-v-5b497d0d><div class="flex justify-between items-start mb-4" data-v-5b497d0d><div data-v-5b497d0d><span class="text-[10px] font-black uppercase tracking-widest text-blue-500/80 mb-1 block" data-v-5b497d0d>${ssrInterpolate(__props.team.game.name)}</span><h3 class="text-xl font-black uppercase italic tracking-tighter text-white group-hover:text-blue-500 transition-colors" data-v-5b497d0d>${ssrInterpolate(__props.team.name)}</h3></div><div class="w-10 h-10 rounded bg-slate-950 border border-blue-900/30 flex items-center justify-center text-blue-500 font-black italic shadow-inner" data-v-5b497d0d>${ssrInterpolate(__props.team.name.charAt(0))}</div></div><p class="text-slate-500 text-xs mb-6 uppercase font-bold tracking-tight" data-v-5b497d0d> Led by <span class="text-slate-300" data-v-5b497d0d>@${ssrInterpolate(__props.team.leader.username)}</span></p><div class="mt-auto pt-4 border-t border-blue-900/10 flex justify-between items-center text-[11px] font-bold uppercase tracking-widest text-slate-500" data-v-5b497d0d><div class="flex items-center space-x-2" data-v-5b497d0d><span class="w-2 h-2 rounded-full bg-blue-600 animate-pulse" data-v-5b497d0d></span><span data-v-5b497d0d>${ssrInterpolate(__props.team.members_count || 1)} Members</span></div><span data-v-5b497d0d>${ssrInterpolate(formatDate(__props.team.created_at))}</span></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="inline-block skew-x-[10deg]" data-v-5b497d0d${_scopeId}>View Profile</span>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-5b497d0d"]]), { __name: "TeamCard" });
...
//# sourceMappingURL=index-C-LwoQ2E.mjs.map
