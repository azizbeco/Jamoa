...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: tournaments, pending, error } = ([__temp, __restore] = withAsyncContext(() => useFetch(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(tournaments), (t) => {
        ...
        _push(`<button class="flex-1 bg-red-600 hover:bg-red-700 text-white py-3 rounded-xl font-black uppercase text-[10px] transition-all skew-x-[-12deg] shadow-[0_0_20px_rgba(220,38,38,0.3)]"><span class="inline-block skew-x-[12deg]">Enlist</span></button></div></div></div>`);
      });
      _push(`<!--]-->`);
...
//# sourceMappingURL=index-oHNFJ-S5.mjs.map
